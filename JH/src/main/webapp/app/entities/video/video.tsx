    ...
    <div>
      <h2 id="video-heading" data-cy="VideoHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/video/new" className="btn btn-primary jh-create-entity" id="jh-create-entity"
          ...
          <Table responsive>
            ...
            <tr>
              <th className="hand" onClick={sort('id')}>
                <Translate contentKey="jhApp.video.id">ID</Translate> <FontAwesomeIcon
                icon={getSortIconByFieldName('id')}/>
              </th>
              <th className="hand" onClick={sort('title')}>
                <Translate contentKey="jhApp.video.title">Title</Translate> <FontAwesomeIcon
                icon={getSortIconByFieldName('title')}/>
              </th>
              ...
              <th className="hand" onClick={sort('season')}>
                <Translate contentKey="jhApp.video.season">Season</Translate> <FontAwesomeIcon
                icon={getSortIconByFieldName('season')}/>
              </th>
              <th className="hand" onClick={sort('rating')}>
                <Translate contentKey="jhApp.video.rating">Rating</Translate> <FontAwesomeIcon
                icon={getSortIconByFieldName('rating')}/>
              </th>
              ...
              <tr key={`entity-${i}`} data-cy="entityTable">
                ...
                <td className="text-end">
                  <div className="btn-group flex-btn-group-container">
                    ...
                    <Button tag={Link} to={`/video/${video.id}/edit`} color="primary" size="sm"
